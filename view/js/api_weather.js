...
export const resultApi = (value_city) => {
    try {
        ...
        // const result = fetch(`${api.baseApi}?format=${api.returnFormat}&array_limit=7&fields=only_results,${valuesRequireds}&woeid=455819`) // Link de chamada para API seguindo todos os parâmetros
